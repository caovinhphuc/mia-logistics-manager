// Script cập nhật Google Sheet với credentials đã cấu hình
...
async function updateSheetWithCredentials() {
  try {
    console.log('🚀 BẮT ĐẦU CẬP NHẬT GOOGLE SHEET VỚI CREDENTIALS...');
    console.log(`📊 Spreadsheet ID: ${SPREADSHEET_ID}`);
    console.log(`📋 Sheet Name: ${SHEET_NAME}`);
    console.log('');

    // Cấu hình credentials từ file
    ...
    console.log(`✅ Đã load credentials từ: ${credentialsPath}`);
    console.log(`📧 Service Account: ${credentials.client_email}`);
    console.log('');

    // Khởi tạo Google Sheets API với credentials
...
if (require.main === module) {
  updateSheetWithCredentials();
}

module.exports = { updateSheetWithCredentials };

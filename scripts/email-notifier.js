...
System Status: All services running`;
    ...
    const html = `
      ...
      <p><strong>Backend:</strong> <a href="http://localhost:5050">http://localhost:5050</a></p>
      <p><strong>Health Check:</strong> <a href="http://localhost:5050/health">http://localhost:5050/health</a></p>

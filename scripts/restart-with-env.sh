...
test_connections() {
    ...
    local sheets_response=$(curl -s http://localhost:5050/api/sheets/test)
...
echo "Backend: http endpoint:5050"
echo "Health Check: http://localhost:5050/health"
echo "Google Sheets Test: http://localhost:5050/api/sheets/test"
echo ""

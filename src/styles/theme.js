...
const getComponentStyles = (isDarkMode) => ({
  MuiButton: {
    styleOverrides: {
      root: {
        ...
        '&:hover': {
          boxShadow: isDarkMode ? '0 4px 8px rgba(0,0,0,0.3)' : '0 2px 4px rgba(0,0,0,0.12)',
  ...
  MuiCard: {
    styleOverrides: {
      root: {
        ...
        boxShadow: isDarkMode ? '0 4px 8px rgba(0,0,0,0.3)' : '0 2px 8px rgba(0,0,0,0.1)',
  ...
  MuiPaper: {
    styleOverrides: {
      ...
      elevation1: {
        boxShadow: isDarkMode ? '0 2px 4px rgba(0,0,0,0.3)' : '0 1px 3px rgba(0,0,0,0.12)',
      },
      elevation2: {
        boxShadow: isDarkMode ? '0 4px 8px rgba(0,0,0,0.3)' : '0 2px 6px rgba(0,0,0,0.15)',
      },
      elevation3: {
        boxShadow: isDarkMode ? '0 6px 12px rgba(0,0,0,0.4)' : '0 3px 9px rgba(0,0,0,0.18)',
      },
    },
  },
  ...
  MuiDialog: {
    styleOverrides: {
      paper: {
        borderRadius: shapeConfig.borderRadiusLg,
        boxShadow: isDarkMode ? '0 20px 40px rgba(0,0,0,0.5)' : '0 10px 20px rgba(0,0,0,0.2)',
      },
    },
  },
...
export const getTransportColor = (theme) => theme.palette.logistics.transport.main;
export const getWarehouseColor = (theme) => theme.palette.logistics.warehouse.main;
...
export const getCompletedColor = (theme) => theme.palette.logistics.completed.main;
export const getPendingColor = (theme) => theme.palette.logistics.pending.main;
export const getCancelledColor = (theme) => theme.palette.logistics.cancelled.main;
...
export const getResponsiveValue = (theme, values) => {
  ...
  for (let i = breakpoints.length - 1; i >= 0; i--) {
    ...
    if (values[breakpoint] && window.innerWidth >= currentBreakpoint[breakpoint]) {

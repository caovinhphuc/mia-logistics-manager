...
const ForgotPassword = () => {
  ...
  // Removed unused 't' and 'theme' variables to fix linter warning
            ...
            {!isEmailSent ? (
              ...
              <Box sx={{ textAlign: 'center' }}>
                ...
                <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                  Chúng tôi đã gửi link khôi phục mật khẩu đến email của bạn. Vui lòng kiểm tra hộp
        ...
        {isLocked && (
          ...
          >
            <Alert severity="error" sx={{ mt: 2 }} icon={<ErrorIcon />}>
              <Typography variant="body2">
                Tài khoản bị khóa do yêu cầu khôi phục quá nhiều lần. Vui lòng thử lại sau 5 phút.
              </Typography>
            </Alert>
          </motion.div>
        )}

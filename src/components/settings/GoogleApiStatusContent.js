...
const GoogleAPIStatusContent = ({ showCard = true }) => {
  ...
  const testGoogleAPI = async () => {
    ...
    try {
      ...
      const hasClientId = !!(
        process.env.REACT_APP_GOOGLE_CLIENT_ID || "placeholder"
      );
      const hasApiKey = !!(
        process.env.REACT_APP_GOOGLE_API_KEY || "placeholder"
      );
      const hasSpreadsheetId = !!(
        process.env.REACT_APP_GOOGLE_SPREADSHEET_ID || "placeholder"
      );
    ...
    <Box>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={4}>
          ...
          >
            <Box sx={{ mb: 2 }}>
              {getStatusIcon(status.googleAPI)}
            </Box>
        ...
        <Grid item xs={12} md={4}>
          ...
          >
            <Box sx={{ mb: 2 }}>
              {getStatusIcon(status.googleSheets)}
            </Box>
            <Typography variant="h6" sx={{ mb: 1, fontWeight: 500 }}>
              Google Sheets
            </Typography>
        ...
        <Grid item xs={12} md={4}>
          ...
          >
            <Box sx={{ mb: 2 }}>
              {getStatusIcon(status.googleDrive)}
            </Box>
            <Typography variant="h6" sx={{ mb: 1, fontWeight: 500 }}>
              Google Drive
            </Typography>
      ...
      {/* Technical Details */}
      <Typography variant="h6" gutterBottom sx={{ mt: 4, mb: 3, display: 'flex', alignItems: 'center', gap: 1 }}>
      ...
      <Grid container spacing={3}>
        <Grid item xs={12} md={4}>
          <Box sx={{ p: 3, bgcolor: 'background.default', borderRadius: 2, border: 1, borderColor: 'divider', height: '100%' }}>
        ...
        {!status.googleAPI && (
          <Alert severity="info">
            <Typography variant="body2">
              ...
              Ứng dụng đang sử dụng dữ liệu mẫu để đảm bảo hoạt động ổn định.
            </Typography>
          </Alert>
        )}

          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <Controller
                name="address"
                control={control}
                render={({ field }) => <TextField {...field} label="Địa chỉ" fullWidth />}
              />
            </Grid>
            <Grid item xs={12} md={6}>
              <Controller
                name="serviceAreas"
                control={control}
                render={({ field }) => <TextField {...field} label="Khu vực phục vụ" fullWidth />}
              />
            </Grid>
            <Grid item xs={12} md={6}>
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <TextField {...field} select label="Phương thức tính giá" fullWidth>
            ...
            <Grid item xs={6} md={3}>
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <TextField {...field} type="number" label="Base rate" fullWidth />
                )}
              />
            </Grid>
            <Grid item xs={6} md={3}>
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <TextField {...field} type="number" label="Giá/km" fullWidth />
                )}
              />
            </Grid>
            <Grid item xs={6} md={3}>
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <TextField {...field} type="number" label="Giá/m3" fullWidth />
                )}
              />
            </Grid>
            <Grid item xs={6} md={3}>
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <TextField {...field} type="number" label="Giá/chuyến" fullWidth />
                )}
              />
            </Grid>
            <Grid item xs={4}>
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <TextField {...field} type="number" label="Phụ phí xăng" fullWidth />
                )}
              />
            </Grid>
            <Grid item xs={4}>
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <TextField {...field} type="number" label="Phí vùng xa" fullWidth />
                )}
              />
            </Grid>
            <Grid item xs={4}>
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <TextField {...field} type="number" label="Bảo hiểm" fullWidth />
                )}
              />
            </Grid>
            <Grid item xs={12} md={6}>
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <TextField {...field} label="Loại xe (VD: Van,Truck)" fullWidth />
                )}
              />
            </Grid>
            <Grid item xs={6} md={3}>
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <TextField {...field} type="number" label="Tải trọng tối đa (kg)" fullWidth />
                )}
              />
            </Grid>
            <Grid item xs={6} md={3}>
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <TextField {...field} type="number" label="Thể tích tối đa (m3)" fullWidth />
                )}
              />
            </Grid>
            <Grid item xs={12} md={6}>
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <TextField {...field} label="Giờ hoạt động (VD: 06:00-22:00)" fullWidth />
                )}
              />
            </Grid>
            <Grid item xs={12} md={6}>

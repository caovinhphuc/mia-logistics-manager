          ...
          <Card sx={{ p: 3, boxShadow: theme.shadows[8] }}>
            <Box sx={{ textAlign: 'center' }}>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                Link khôi phục mật khẩu không hợp lệ hoặc đã hết hạn. Vui lòng yêu cầu khôi phục mật
                khẩu mới.
              </Typography>
              <Button
                variant="contained"
          ...
          <Card sx={{ p: 3, boxShadow: theme.shadows[8] }}>
            {!isSuccess ? (
              ...
              <Box sx={{ textAlign: 'center' }}>
                ...
                <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                  Mật khẩu của bạn đã được đặt lại thành công. Bây giờ bạn có thể đăng nhập với mật
                  khẩu mới.
                </Typography>
                <Button
                  variant="contained"

...
const getMenuItems = (t) => [
  ...
  },
  {
    ...
    color: 'secondary',
    children: [
      { key: 'requests', text: t('navigation.requests'), path: '/transport/requests', roles: ['admin', 'manager', 'operator'] },
      { key: 'routes', text: t('navigation.routes'), path: '/transport/routes', roles: ['admin', 'manager'] },
      { key: 'vehicles', text: t('navigation.vehicles'), path: '/transport/vehicles', roles: ['admin', 'manager'] },
    ],
  },
  {
    key: 'warehouse',
    ...
    color: 'info',
    children: [
      { key: 'inventory', text: t('navigation.inventory'), path: '/warehouse/inventory', roles: ['admin', 'manager', 'warehouse_staff'] },
      { key: 'orders', text: t('navigation.orders'), path: '/warehouse/orders', roles: ['admin', 'manager'] },
      { key: 'locations', text: t('navigation.locations'), path: '/warehouse/locations', roles: ['admin', 'manager'] },
    ],
  },
  {
    key: 'staff',
    text: t('navigation.staff'),
    icon: <StaffIcon />,
    path: '/staff',
    roles: ['admin', 'manager'],
    color: 'success',
    children: [
      { key: 'employees', text: t('navigation.employees'), path: '/staff/employees', roles: ['admin', 'manager'] },
      { key: 'schedules', text: t('navigation.schedules'), path: '/staff/schedules', roles: ['admin', 'manager'] },
      { key: 'performance', text: t('navigation.performance'), path: '/staff/performance', roles: ['admin', 'manager'] },
    ],
  },
  {
    key: 'partners',
    ...
    color: 'warning',
    children: [
      { key: 'suppliers', text: t('navigation.suppliers'), path: '/partners/suppliers', roles: ['admin', 'manager'] },
      { key: 'customers', text: t('navigation.customers'), path: '/partners/customers', roles: ['admin', 'manager', 'operator'] },
      { key: 'contracts', text: t('navigation.contracts'), path: '/partners/contracts', roles: ['admin', 'manager'] },
    ],
  },
  {
    key: 'maps',
  ...
  },
  {
    ...
    color: 'primary',
    children: [
      { key: 'analytics', text: t('navigation.analytics'), path: '/reports/analytics', roles: ['admin', 'manager'] },
      { key: 'financial', text: t('navigation.financial'), path: '/reports/financial', roles: ['admin', 'manager'] },
      { key: 'performance_reports', text: t('navigation.performance'), path: '/reports/performance', roles: ['admin', 'manager'] },
    ],
  },
  {
    key: 'settings',
    ...
    color: 'secondary',
    children: [
      { key: 'general', text: t('navigation.general_settings'), path: '/settings/general', roles: ['admin'] },
      { key: 'api_integration', text: t('navigation.api_integration'), path: '/settings/api', roles: ['admin'] },
      { key: 'security', text: t('navigation.security_settings'), path: '/settings/security', roles: ['admin'] },
      { key: 'system', text: t('navigation.system_settings'), path: '/settings/system', roles: ['admin'] },
    ],
  },
];
  ...
  const drawer = (
    <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      <Box sx={{ flexGrow: 1, overflow: 'auto' }}>
        <List>
          {getMenuItems(t).map((item) => renderMenuItem(item))}
        </List>
      </Box>
